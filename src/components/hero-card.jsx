...
const data= [
  ...
  const HeroCard = ({ name, url, alterego, superpowers, info, rating, onRatingChange }) => (
      ...
      <div className="rating">
        {[1, 2, 3, 4, 5].map(star => (
          <span
            ...
            style={{ cursor: 'pointer', color: star <= rating ? 'yellow' : 'gray' }}
          >
            ★
          </span>
        ))}
      ...
      <div className="hero-list">
        {data.map(hero => (
          <HeroCard
            ...
            info={hero.info}
            rating={ratings[hero.name] || 0}
            onRatingChange={newRating => handleRatingChange(hero.name, newRating)}
          />
        ))}
      </div>
    );
